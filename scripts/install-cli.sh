...
target_dir=${PARALLEL_INTEGRATOR_BIN_DIR:-${CODEX_HANDOFF_BIN_DIR:-"${HOME}/.local/bin"}}
target_file="$target_dir/parallel-integrator"
...
printf '%s\n' "Installed parallel-integrator at $target_file"
