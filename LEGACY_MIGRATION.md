...
Keep the existing daemon/watcher project intact while introducing `codex-handoff`.
...
- old daemon integrating a branch while `codex-handoff` integrates the same work
...
Replace them with the new `codex-handoff-workflow` snippet.
